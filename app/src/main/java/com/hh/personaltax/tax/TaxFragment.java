package com.hh.personaltax.tax;
...
import com.hh.personaltax.adapter.CostListAdapter;
import com.hh.personaltax.base.BaseFragment;
import com.hh.personaltax.base.TaxApplication;
import com.hh.personaltax.calculator.CalculatorFilterActivity;
import com.hh.personaltax.greendao.gen.CostItemDao;
import com.hh.personaltax.model.CostItem;
import com.hh.personaltax.model.CostListItem;
import com.hh.personaltax.model.CostListItemSectioner;
import com.hh.personaltax.setting.CostCheckActivity;
...
public class TaxFragment extends BaseFragment {
    ...
    private void loadAllList() {
        ...
        // 获取数据库中数据
        List<CostItem> tempData = TaxApplication.getDaoInstant()
                                                .getCostItemDao()
                                                .queryBuilder()
