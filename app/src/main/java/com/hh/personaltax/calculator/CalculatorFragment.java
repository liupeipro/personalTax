...
import com.hh.personaltax.adapter.CalculatorListAdapter;
...
import com.hh.personaltax.model.CalculatorListItem;
import com.hh.personaltax.model.CostItem;
import com.hh.personaltax.model.CostItemAmountType;
import com.hh.personaltax.setting.CostAddActivity;
import com.hh.personaltax.util.FloatUtils;
...
public class CalculatorFragment extends BaseFragment {
    ...
    private List<CostItem> getDbData(String dataType, Long amountTypeId) {
        ...
        if (dataType.equals(CALCULATOR_COST_CHART_TYPE)) {
            result = TaxApplication.getDaoInstant()
                                   .getCostItemDao()
                                   .queryBuilder()
                                   .where(
