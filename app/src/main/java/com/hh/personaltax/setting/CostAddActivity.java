...
import com.hh.personaltax.adapter.CostAddTypeAdapter;
...
import com.hh.personaltax.greendao.gen.CostItemTypeDao;
import com.hh.personaltax.model.CostItem;
import com.hh.personaltax.model.CostItemAccount;
import com.hh.personaltax.model.CostItemAmountType;
import com.hh.personaltax.model.CostItemType;
import com.hh.personaltax.util.TimeUtil;
import com.hh.personaltax.view.BottomBar;
import com.hh.personaltax.view.BottomTextBarTab;
import com.hh.personaltax.view.InputAmountView;
...
public class CostAddActivity extends BaseActivity {
    ...
    private void onSubmit(CostItem item) {
        if (item.getCostAmount().isEmpty()) {
            ...
            long temp =
                TaxApplication.getDaoInstant().getCostItemDao().insertOrReplace(this.mCostItem);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentItemId != -1L) {
            ...
            this.mCostItem = (CostItem) TaxApplication.getDaoInstant()
                                                      .getCostItemDao()
                                                      .queryBuilder()
                                                      .where(CostItemDao.Properties._id.eq(
                                                          intentItemId))
                                                      .unique();
