...
////
//
//package com.hh.smartmoney.cost;
//
...
//import com.hh.smartmoney.R;
//import com.hh.smartmoney.adapter.CostAddTypeAdapter;
//import com.hh.smartmoney.base.BaseActivity;
//import com.hh.smartmoney.base.TaxApplication;
//import com.hh.smartmoney.model.CostItem;
//import com.hh.smartmoney.model.CostItemAccount;
//import com.hh.smartmoney.model.CostItemAmountType;
//import com.hh.smartmoney.model.CostItemType;
//import com.hh.smartmoney.util.TimeUtil;
//import com.hh.smartmoney.view.BottomBar;
//import com.hh.smartmoney.view.BottomBar.OnTabSelectedListener;
//import com.hh.smartmoney.view.BottomTextBarTab;
//import com.hh.smartmoney.view.InputAmountView;
//import com.hh.smartmoney.view.InputAmountView.OnAmountClickListener;
...
public class CostAddActivity extends BaseActivity {
    ...
    //      long temp = TaxApplication.getDaoInstant().getCostItemDao().insertOrReplace(this.mCostItem);
    ...
    //    this.mAmountTypes = TaxApplication.getDaoInstant().getCostItemAmountTypeDao().loadAll();
    ...
    //        this.mGridInData = TaxApplication.getDaoInstant()
    //            .getCostItemTypeDao()
    //            .queryBuilder()
    ...
    //        this.mGridOutData = TaxApplication.getDaoInstant()
    //            .getCostItemTypeDao()
    //            .queryBuilder()
    //            .where(Properties.AmountTypeId.eq(item.get_id()))
    //            .list();
    ...
    //    }
    //
    //    this.mAccountListData = TaxApplication.getDaoInstant().getCostItemAccountDao().loadAll();
    ...
    //      this.mCostItem = (CostItem) TaxApplication.getDaoInstant()
    //          .getCostItemDao()
    //          .queryBuilder()
    //          .where(com.hh.smartmoney.greendao.gen.CostItemDao.Properties._id.eq(intentItemId))
    //          .unique();
